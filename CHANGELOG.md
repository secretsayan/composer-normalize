...
For a full diff see [`2.17.0...2.17.0`][2.17.0...2.18.0].

### Changed

- Started passing through `--ansi`, `--no-ansi`, `-v`, `-vv`, `-vvv`, and `--verbose` options to `UpdateCommand` when updating locker ([#827]), by [@localheinz]
